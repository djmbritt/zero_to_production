...
mod tests {
    ...
    async fn send_email_succeeds_if_the_server_returns_200() {
        // Setup Mock Server and EmailClient and email parameters
    ...
    #[tokio::test]
    async fn send_email_times_out_if_the_server_takes_took_long() {
        // Setup
        let mock_server = MockServer::start().await;
        let email_client = email_client(mock_server.uri());

        // Create a response that took 3 minutes to respond
